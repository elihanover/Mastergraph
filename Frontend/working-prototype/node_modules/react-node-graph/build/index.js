(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactNodeGraph"] = factory(require("react"));
	else
		root["ReactNodeGraph"] = factory(root["React"]);
	...
	var index = (function (_React$Component) {
		...
		_createClass(index, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement('div', { className: dragging ? 'dragging' : '' }, nodes.map(function (node) {
				...
				}), _react2['default'].createElement(_libSVGComponent2['default'], { height: '100%', width: '100%', ref: 'svgComponent' }, connectors.map(function (connector) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactOnclickoutside = __webpack_require__(3);
	
	var _reactOnclickoutside2 = _interopRequireDefault(_reactOnclickoutside);
	
	var _NodeInputList = __webpack_require__(157);
	
	var _NodeInputList2 = _interopRequireDefault(_NodeInputList);
	
	var _NodeOutputList = __webpack_require__(159);
	
	var _NodeOutputList2 = _interopRequireDefault(_NodeOutputList);
	
	var Draggable = __webpack_require__(161);
	...
	var Node = (function (_React$Component) {
	  ...
	  _createClass(Node, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('div', { onDoubleClick: function onDoubleClick(e) {
	          _this.handleClick(e);
	        } }, _react2['default'].createElement(Draggable, {
	        ...
	        } }, _react2['default'].createElement('section', { className: nodeClass, style: { zIndex: 10000 } }, _react2['default'].createElement('header', { className: 'node-header', style: { backgroundColor: this.props.color } }, _react2['default'].createElement('span', { className: 'node-title' }, this.props.title)), _react2['default'].createElement('div', { className: 'node-content' }, _react2['default'].createElement(_NodeInputList2['default'], { items: this.props.inputs, onCompleteConnector: function onCompleteConnector(index) {
	          return _this.onCompleteConnector(index);
	        } }), _react2['default'].createElement(_NodeOutputList2['default'], { items: this.props.outputs, onStartConnector: function onStartConnector(index) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (root) {
	   ...
	   */
	  var isNodeFound = function isNodeFound(current, componentNode, ignoreClass) {
	   ...
	   */
	  var findHighest = function findHighest(current, componentNode, ignoreClass) {
	    if (current === componentNode) {
	      return true;
	    }
	   ...
	   */
	  var clickedScrollbar = function clickedScrollbar(evt) {
	   ...
	   */
	  var generateOutsideCheck = function generateOutsideCheck(componentNode, componentInstance, eventHandler, ignoreClass, excludeScrollbar, preventDefault, stopPropagation) {
	    return function (evt) {
	      if (preventDefault) {
	        evt.preventDefault();
	      }
	  ...
	  function setupHOC(root, React, ReactDOM, createReactClass) {
	    ...
	    return function onClickOutsideHOC(Component, config) {
	      var wrapComponentWithOnClickOutsideHandling = createReactClass({
	        ...
	        __outsideClickHandler: function __outsideClickHandler() {},
	        ...
	        componentDidMount: function componentDidMount() {
	          ...
	          var fn = this.__outsideClickHandler = generateOutsideCheck(componentNode, instance, clickOutsideHandler, this.props.outsideClickIgnoreClass || IGNORE_CLASS, this.props.excludeScrollbar, // fallback not needed, prop always exists because of getDefaultProps
	          this.props.preventDefault || false, this.props.stopPropagation || false);
	  ...
	  function setupBinding(root, factory) {
	    if (true) {
	      ...
	      !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(4), __webpack_require__(150)], __WEBPACK_AMD_DEFINE_RESULT__ = function (React, ReactDom, createReactClass) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _NodeInputListItem = __webpack_require__(158);
	...
	var NodeInputList = (function (_React$Component) {
		...
		_createClass(NodeInputList, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement('div', { className: 'nodeInputWrapper' }, _react2['default'].createElement('ul', { className: 'nodeInputList' }, this.props.items.map(function (item) {
	...
	var NodeInputListItem = (function (_React$Component) {
		...
		_createClass(NodeInputListItem, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement('li', null, _react2['default'].createElement('a', { onClick: function onClick(e) {
						return _this.noop(e);
					}, onMouseUp: function onMouseUp(e) {
						return _this.onMouseUp(e);
					}, href: '#' }, _react2['default'].createElement('i', { className: hover ? 'fa fa-circle-o hover' : 'fa fa-circle-o',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _NodeOutputListItem = __webpack_require__(160);
	...
	var NodeOutputList = (function (_React$Component) {
		...
		function NodeOutputList() {
			...
			_get(Object.getPrototypeOf(NodeOutputList.prototype), 'constructor', this).apply(this, arguments);
		}
		...
		_createClass(NodeOutputList, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement('div', { className: 'nodeOutputWrapper' }, _react2['default'].createElement('ul', { className: 'nodeOutputList' }, this.props.items.map(function (item) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NodeOutputListItem = (function (_React$Component) {
		...
		function NodeOutputListItem() {
			...
			_get(Object.getPrototypeOf(NodeOutputListItem.prototype), "constructor", this).apply(this, arguments);
		}
		...
		_createClass(NodeOutputListItem, [{
			...
			value: function render() {
				...
				return _react2["default"].createElement("li", { onMouseDown: function onMouseDown(e) {
						return _this.onMouseDown(e);
					} }, _react2["default"].createElement("a", { href: "#", onClick: function onClick(e) {
						return _this.noop(e);
					} }, this.props.item.name, " ", _react2["default"].createElement("i", { className: "fa fa-circle-o" })));
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if (true) module.exports = factory(__webpack_require__(1), __webpack_require__(4));else if (typeof define === 'function' && define.amd) define(["react", "react-dom"], factory);else if (typeof exports === 'object') exports["ReactDraggable"] = factory(require("react"), require("react-dom"));else root["ReactDraggable"] = factory(root["React"], root["ReactDOM"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TrashIcon = __webpack_require__(163);
	...
	var Spline = (function (_React$Component) {
	  ...
	  _createClass(Spline, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('g', null, _react2['default'].createElement('circle', { cx: start.x, cy: start.y, r: '3', fill: '#337ab7' }), _react2['default'].createElement('circle', { cx: end.x, cy: end.y, r: '3', fill: '#9191A8' }), _react2['default'].createElement('path', { className: 'connector-click-area', d: pathString, onClick: function onClick(e) {
	          _this.handleClick(e);
	        } }), _react2['default'].createElement('path', { className: className, d: pathString, onClick: function onClick(e) {
	          _this.handleClick(e);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SVGComponent = (function (_Component) {
	  ...
	  _createClass(SVGComponent, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement('svg', _extends({ style: { position: 'absolute', zIndex: 9000 } }, this.props, { ref: 'svg' }), this.props.children);
	    }
	  }]);
